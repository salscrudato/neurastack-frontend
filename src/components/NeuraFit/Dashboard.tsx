      ...
      >
          ...
          <SimpleGrid columns={2} spacing={{ base: 3, md: 2 }} w="100%">
            ...
            >
              <CardBody
                ...
                w="100%"
              >
                <VStack spacing={{ base: 2, md: 1 }} align="center" justify="center" w="100%">
                  <Icon as={PiTrophyBold} boxSize={{ base: 6, md: 5 }} color="blue.400" mx="auto" />
                  <Text
            ...
            >
              ...
              >
                <VStack spacing={{ base: 2, md: 1 }} align="center" justify="center" w="100%">
                  <Icon as={PiHeartBold} boxSize={{ base: 6, md: 5 }} color="green.400" mx="auto" />
                  <Text
                    fontSize={{ base: "sm", md: "xs" }}
                    fontWeight="medium"
                    color="gray.700"
            ...
            >
              ...
              >
                <VStack spacing={{ base: 2, md: 1 }} align="center" justify="center" w="100%">
                  <Icon as={PiTrophyBold} boxSize={{ base: 6, md: 5 }} color="orange.400" mx="auto" />
                  <Text
                    fontSize={{ base: "sm", md: "xs" }}
                    fontWeight="medium"
                    color="gray.700"
            ...
            >
              ...
              >
                <VStack spacing={{ base: 2, md: 1 }} align="center" justify="center" w="100%">
                  <Icon as={PiHeartBold} boxSize={{ base: 6, md: 5 }} color="teal.400" mx="auto" />
                  <Text
                    fontSize={{ base: "sm", md: "xs" }}
                    fontWeight="medium"
                    color="gray.700"
            ...
            >
              ...
              >
                <VStack spacing={{ base: 2, md: 1 }} align="center" justify="center" w="100%">
                  <Icon as={PiHeartBold} boxSize={{ base: 6, md: 5 }} color="red.400" mx="auto" />
                  <Text
                    fontSize={{ base: "sm", md: "xs" }}
                    fontWeight="medium"
                    color="gray.700"
            ...
            >
              ...
              >
                <VStack spacing={{ base: 2, md: 1 }} align="center" justify="center" w="100%">
                  <Icon as={PiClockBold} boxSize={{ base: 6, md: 5 }} color="purple.400" mx="auto" />
                  <Text
                    fontSize={{ base: "sm", md: "xs" }}
                    fontWeight="medium"
                    color="gray.700"
        ...
        <VStack spacing={{ base: 4, md: 3 }} w="100%" pt={{ base: 2, md: 1 }}>
          ...
          <Button
            ...
            leftIcon={<Icon as={PiPlayBold} boxSize={{ base: 4, md: 4 }} />}
          ...
          <VStack spacing={{ base: 3, md: 2 }} w="100%">
            <Button
              ...
              leftIcon={<Icon as={PiTrophyBold} boxSize={{ base: 4, md: 3 }} />}
            ...
            {onViewHistory && (
              <Button
                ...
                h={{ base: "40px", md: "36px" }}
                minH={{ base: "40px", md: "36px" }}
                leftIcon={<Icon as={PiClockBold} boxSize={{ base: 4, md: 3 }} />}
